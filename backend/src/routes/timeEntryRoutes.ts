...
router.post('/start', (req, res, next) => timeEntryController.start(req, res, next));
router.post('/manual', (req, res, next) => timeEntryController.createManual(req, res, next));
router.get('/stats', (req, res, next) => timeEntryController.getStats(req, res, next));

// 停止计时
router.patch('/:id/stop', (req, res, next) => timeEntryController.stop(req, res, next));
...
router.put('/:id', (req, res, next) => timeEntryController.update(req, res, next));
